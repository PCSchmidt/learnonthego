  ...
  return (
    <View style={styles.urlCard}>
      ...
      <TextInput
        ...
        accessibilityLabel="Source URL input"
        accessibilityHint="Enter the article, YouTube, or podcast feed URL you want to diagnose"
      ...
      <TouchableOpacity
        ...
        accessibilityLabel="Run URL diagnostics"
        accessibilityHint="Checks whether the provided URL is reachable and supported"
        accessibilityState={{ disabled: isDiagnosticsLoading }}
